...
<nav>
    ...
    <a  href="film.php?do=Add">اضافة عنصر</a>
      ...
      <div class="col-lg-4 col-sm-12 " style="margin-top:10px; ">
              <div class="card" style="width: 14rem;" >
                  ...
                  <div class="card-body" style="background-color:#e6ffe6;">
                      ...
                      <br>
                      <a href="film.php?do=Edit&std=<?php echo $u['id'];?>" class="btn btn-primary">تعديل</a>
                      <a href="film.php?do=Delete&std=<?php echo $u['id'];?>"class="btn btn-danger">حذف</a>
...
header("location:film.php");
    ...
    elseif($do == "Update"){
        ...
        move_uploaded_file($temp,$folder);
            ...
            $stmt2 = $con->prepare("UPDATE library SET name = ? , link =? , type='film',image=?  WHERE id = ?");
